/* MODULO HOME (Wiki) + CONFIGURACOES DA HOME - JavaScript
   Cole estes membros DENTRO do objeto App (antes do fecha-chaves final).
   Requer em State: kb, kbCategorias, kbNotif
   Requer os listeners de kbProblemas, kbCategorias e kbNotif. */
